app.get("/ships/admin/new", function(req, res) {
    ...
    res.render("ship/create.ejs", {error_message: "", success_message: ""});
});
...
app.post("/ships/admin/create_new", function(req, res) {    
    ...
    Ship.save(function(err) {
        if(err) {
            console.log(err);
            res.render("ship/create.ejs", {error_message: err, success_message: ""});
            return;
        }    
        
        console.log("saved new shipbase to mongo");
        res.render("ship/create.ejs", {error_message: "", success_message: "Awesome, Saved!"});
    });
});